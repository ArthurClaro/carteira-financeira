    ...
    <div class="animate-fade-up stagger-1 rounded-xl border border-brand-100 bg-white p-8 shadow-sm">
        ...
        <form wire:submit="register" class="space-y-4">
            <div>
                ...
                @error('name') <p class="animate-slide-in mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
            </div>
            ...
            <button type="submit" wire:loading.attr="disabled" wire:target="register"
                ...
                <svg wire:loading wire:target="register" class="size-4 animate-spin" viewBox="0 0 24 24" fill="none" aria-hidden="true">
        ...
        <p class="mt-6 text-center text-sm text-gray-600">
            Já tem conta?
            <a href="{{ route('login') }}" wire:navigate class="font-medium text-brand-700 hover:underline">Entrar</a>
        </p>
    </div>
</div>
